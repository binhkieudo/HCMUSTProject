...
module ScratchpadSlavePort(
  ...
  wire [31:0]     _io_dmem_req_bits_T_1_address = _io_dmem_req_bits_T ? acq_address : auto_in_a_bits_address;	// @[ScratchpadSlavePort.scala:55:18, :105:57, :110:41]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        acq_address = {_RANDOM_0[31:21], _RANDOM_1[20:0]};	// @[ScratchpadSlavePort.scala:46:24, :55:18]
        acq_mask = _RANDOM_1[28:21];	// @[ScratchpadSlavePort.scala:55:18]
        acq_data = {_RANDOM_1[31:29], _RANDOM_2, _RANDOM_3[28:0]};	// @[ScratchpadSlavePort.scala:55:18]
        bundleIn_0_d_bits_data_r = {_RANDOM_3[31:30], _RANDOM_4, _RANDOM_5[29:0]};	// @[Reg.scala:19:16, ScratchpadSlavePort.scala:55:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_dmem_req_bits_addr = {2'h0, _io_dmem_req_bits_T_1_address};	// @[Bundles.scala:259:74, ScratchpadSlavePort.scala:88:16, :110:41]
