...
module TLFragmenter_4(
  ...
  wire [28:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:264:30]
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[8:4];	// @[Fragmenter.scala:228:47]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {23'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
