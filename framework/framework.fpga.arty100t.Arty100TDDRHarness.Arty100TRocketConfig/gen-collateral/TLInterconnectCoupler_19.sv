...
module TLInterconnectCoupler_19(
  ...
  input  [8:0]  auto_fixer_out_d_bits_source,
  ...
  output [8:0]  auto_fixer_out_a_bits_source,
  ...
  wire [8:0]  _fragmenter_auto_out_a_bits_source;	// @[Fragmenter.scala:335:34]
  ...
  wire [8:0]  _fixer_auto_in_d_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  TLFragmenter_12 fragmenter (	// @[Fragmenter.scala:335:34]
    .clock                   (clock),
    .reset                   (reset),
