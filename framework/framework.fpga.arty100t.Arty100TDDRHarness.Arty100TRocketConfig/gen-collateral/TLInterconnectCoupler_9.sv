...
module TLInterconnectCoupler_9(
  ...
  input  [11:0] auto_mem_xing_out_d_bits_source,
  ...
  output [11:0] auto_mem_xing_out_a_bits_source,
  ...
  wire [4:0]  _widget_auto_out_a_bits_source;	// @[WidthWidget.scala:220:28]
  wire [29:0] _widget_auto_out_a_bits_address;	// @[WidthWidget.scala:220:28]
  wire        _widget_auto_out_a_bits_mask;	// @[WidthWidget.scala:220:28]
  ...
  wire [7:0]  _buffer_auto_in_d_bits_data;	// @[Buffer.scala:69:28]
  ...
  wire [29:0] _buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  wire        _buffer_auto_out_a_bits_mask;	// @[Buffer.scala:69:28]
  ...
  wire [7:0]  _fragmenter_auto_in_d_bits_data;	// @[Fragmenter.scala:335:34]
