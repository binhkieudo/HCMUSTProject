...
module TLFragmenter_14(
  ...
  wire        drop = ~(auto_out_d_bits_opcode[0]) & ~(auto_out_d_bits_source[4] ? dFirst : auto_out_d_bits_source[2:0] == 3'h0);	// @[Edges.scala:106:36, Fragmenter.scala:191:29, :194:41, :195:29, :196:30, :221:54, :224:{20,30,33,37}]
  ...
  Repeater_14 repeater (	// @[Fragmenter.scala:264:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_source = {_repeater_io_deq_bits_source, _repeater_io_deq_bits_opcode == 3'h0, ~(aFirst ? dToggle : aToggle_r), old_gennum1};	// @[Cat.scala:33:92, Fragmenter.scala:191:29, :193:30, :264:30, :294:29, :295:30, :299:{23,27}, Mux.scala:81:61, Reg.scala:19:16]
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {26'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
