...
module TLBuffer_14_Arty100TDDRHarness_UNIQUIFIED(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  Queue_22_Arty100TDDRHarness_UNIQUIFIED x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_23_Arty100TDDRHarness_UNIQUIFIED bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
