...
module TLXbar_5(
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1} == 9'h0;	// @[Edges.scala:221:14, Parameters.scala:137:{31,45,65}]
  wire [4:0]  _GEN = auto_in_a_bits_address[29:25] ^ 5'h12;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2} == 9'h0 | {auto_in_a_bits_address[31], ~(auto_in_a_bits_address[28]), auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 8'h0 | {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28] ^ 2'h2, auto_in_a_bits_address[26:25]} == 5'h0 | {auto_in_a_bits_address[31], _GEN[4:3], _GEN[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14]} == 8'h0;	// @[Arbiter.scala:88:30, Bundles.scala:259:74, Edges.scala:221:14, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], ~(auto_in_a_bits_address[26])} == 4'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_3 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25] ^ 2'h1, auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {~(auto_in_a_bits_address[31]), auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 9'h0;	// @[Edges.scala:221:14, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 9'h0;	// @[Edges.scala:221:14, Parameters.scala:137:{45,65}]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_7 = {auto_in_a_bits_address[31], auto_in_a_bits_address[29:28], auto_in_a_bits_address[26:25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[14:13]} == 8'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
