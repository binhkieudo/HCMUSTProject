  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        mem_0 = _RANDOM_0[3:0];	// @[AsyncQueue.scala:80:16]
        mem_1 = _RANDOM_0[7:4];	// @[AsyncQueue.scala:80:16]
        mem_2 = _RANDOM_0[11:8];	// @[AsyncQueue.scala:80:16]
        mem_3 = _RANDOM_0[15:12];	// @[AsyncQueue.scala:80:16]
        mem_4 = _RANDOM_0[19:16];	// @[AsyncQueue.scala:80:16]
        mem_5 = _RANDOM_0[23:20];	// @[AsyncQueue.scala:80:16]
        mem_6 = _RANDOM_0[27:24];	// @[AsyncQueue.scala:80:16]
        mem_7 = _RANDOM_0[31:28];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_1[3:0];	// @[AsyncQueue.scala:52:25]
        ready_reg = _RANDOM_1[4];	// @[AsyncQueue.scala:52:25, :88:56]
        widx_gray = _RANDOM_1[8:5];	// @[AsyncQueue.scala:52:25, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
