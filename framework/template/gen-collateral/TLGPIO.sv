...
module TLGPIO(
  ...
  wire [7:0]        _iofEnReg_io_q;	// @[GPIO.scala:104:25]
  wire [7:0]        _inSyncReg_inSyncReg_io_q;	// @[ShiftReg.scala:45:23]
  wire [7:0]        _poeReg_io_q;	// @[GPIO.scala:83:22]
  wire [7:0]        _ieReg_io_q;	// @[GPIO.scala:81:22]
  wire [7:0]        _pueReg_io_q;	// @[GPIO.scala:79:22]
  wire [7:0]        _oeReg_io_q;	// @[GPIO.scala:78:22]
  reg  [7:0]        portReg;	// @[GPIO.scala:76:20]
  reg  [7:0]        dsReg_0;	// @[GPIO.scala:80:23]
  reg  [7:0]        valueReg;	// @[GPIO.scala:89:23]
  reg  [7:0]        highIeReg;	// @[GPIO.scala:92:22]
  reg  [7:0]        lowIeReg;	// @[GPIO.scala:93:22]
  reg  [7:0]        riseIeReg;	// @[GPIO.scala:94:22]
  reg  [7:0]        fallIeReg;	// @[GPIO.scala:95:22]
  reg  [7:0]        highIpReg;	// @[GPIO.scala:96:22]
  reg  [7:0]        lowIpReg;	// @[GPIO.scala:97:22]
  reg  [7:0]        riseIpReg;	// @[GPIO.scala:98:22]
  reg  [7:0]        fallIpReg;	// @[GPIO.scala:99:22]
  reg  [7:0]        passthruHighIeReg;	// @[GPIO.scala:100:30]
  reg  [7:0]        passthruLowIeReg;	// @[GPIO.scala:101:30]
  reg  [7:0]        xorReg;	// @[GPIO.scala:108:22]
  ...
  wire [15:0][39:0] _GEN_0 = {{40'h0}, {40'h0}, {40'h0}, {40'h0}, {40'h0}, {40'h0}, {{32'h0, passthruLowIeReg}}, {{passthruHighIeReg, 24'h0, xorReg}}, {40'h0}, {{lowIpReg, 24'h0, lowIeReg}}, {{highIpReg, 24'h0, highIeReg}}, {{fallIpReg, 24'h0, fallIeReg}}, {{riseIpReg, 24'h0, riseIeReg}}, {{dsReg_0, 24'h0, _pueReg_io_q}}, {{portReg, 24'h0, _oeReg_io_q}}, {{_ieReg_io_q, 24'h0, valueReg}}};	// @[Cat.scala:33:92, GPIO.scala:76:20, :78:22, :79:22, :80:23, :81:22, :89:23, :92:22, :93:22, :94:22, :95:22, :96:22, :97:22, :98:22, :99:22, :100:30, :101:30, :108:22, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
  always @(posedge clock) begin
    if (reset) begin
      portReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:76:20]
      dsReg_0 <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:80:23]
      valueReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:89:23]
      highIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:92:22]
      lowIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:93:22]
      riseIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:94:22]
      fallIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:95:22]
      highIpReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:96:22]
      lowIpReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:97:22]
      riseIpReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:98:22]
      fallIpReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:99:22]
      passthruHighIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:100:30]
      passthruLowIeReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:101:30]
      xorReg <= 8'h0;	// @[Bundles.scala:259:74, GPIO.scala:108:22]
    end
    else begin
      if (out_woready_6 & auto_control_xing_in_a_bits_mask[4])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        portReg <= auto_control_xing_in_a_bits_data[39:32];	// @[GPIO.scala:76:20, RegisterRouter.scala:83:24]
      if (out_woready_12 & auto_control_xing_in_a_bits_mask[4])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        dsReg_0 <= auto_control_xing_in_a_bits_data[39:32];	// @[GPIO.scala:80:23, RegisterRouter.scala:83:24]
      ...
      if (out_woready_3 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        highIeReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:92:22, RegisterRouter.scala:83:24]
      if (out_woready_8 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        lowIeReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:93:22, RegisterRouter.scala:83:24]
      if (out_woready_16 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        riseIeReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:94:22, RegisterRouter.scala:83:24]
      if (out_woready_20 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        fallIeReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:95:22, RegisterRouter.scala:83:24]
      highIpReg <= ~(~highIpReg | (out_woready_3 & auto_control_xing_in_a_bits_mask[4] ? auto_control_xing_in_a_bits_data[39:32] : 8'h0)) | valueReg;	// @[Bitwise.scala:28:17, Bundles.scala:259:74, GPIO.scala:89:23, :96:22, RegField.scala:128:{60,63,69,74,95}, RegisterRouter.scala:83:24]
      lowIpReg <= ~(~lowIpReg | (out_woready_8 & auto_control_xing_in_a_bits_mask[4] ? auto_control_xing_in_a_bits_data[39:32] : 8'h0)) | ~valueReg;	// @[Bitwise.scala:28:17, Bundles.scala:259:74, GPIO.scala:89:23, :97:22, :114:14, RegField.scala:128:{60,63,69,74,95}, RegisterRouter.scala:83:24]
      riseIpReg <= ~(~riseIpReg | (out_woready_16 & auto_control_xing_in_a_bits_mask[4] ? auto_control_xing_in_a_bits_data[39:32] : 8'h0)) | ~valueReg & _inSyncReg_inSyncReg_io_q;	// @[Bitwise.scala:28:17, Bundles.scala:259:74, GPIO.scala:89:23, :98:22, :114:{14,24}, RegField.scala:128:{60,63,69,74,95}, RegisterRouter.scala:83:24, ShiftReg.scala:45:23]
      fallIpReg <= ~(~fallIpReg | (out_woready_20 & auto_control_xing_in_a_bits_mask[4] ? auto_control_xing_in_a_bits_data[39:32] : 8'h0)) | valueReg & ~_inSyncReg_inSyncReg_io_q;	// @[Bitwise.scala:28:17, Bundles.scala:259:74, GPIO.scala:89:23, :99:22, :115:{23,25}, RegField.scala:128:{60,63,69,74,95}, RegisterRouter.scala:83:24, ShiftReg.scala:45:23]
      if (out_woready_18 & auto_control_xing_in_a_bits_mask[4])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        passthruHighIeReg <= auto_control_xing_in_a_bits_data[39:32];	// @[GPIO.scala:100:30, RegisterRouter.scala:83:24]
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[6:3] == 4'h9 & _out_out_bits_data_WIRE_10 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        passthruLowIeReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:101:30, RegisterRouter.scala:83:24]
      if (out_woready_18 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        xorReg <= auto_control_xing_in_a_bits_data[7:0];	// @[GPIO.scala:108:22, RegisterRouter.scala:83:24]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_2 = `RANDOM;
        _RANDOM_3 = `RANDOM;
        portReg = _RANDOM_0[7:0];	// @[GPIO.scala:76:20]
        dsReg_0 = _RANDOM_0[15:8];	// @[GPIO.scala:76:20, :80:23]
        valueReg = _RANDOM_0[31:24];	// @[GPIO.scala:76:20, :89:23]
        highIeReg = _RANDOM_1[7:0];	// @[GPIO.scala:92:22]
        lowIeReg = _RANDOM_1[15:8];	// @[GPIO.scala:92:22, :93:22]
        riseIeReg = _RANDOM_1[23:16];	// @[GPIO.scala:92:22, :94:22]
        fallIeReg = _RANDOM_1[31:24];	// @[GPIO.scala:92:22, :95:22]
        highIpReg = _RANDOM_2[7:0];	// @[GPIO.scala:96:22]
        lowIpReg = _RANDOM_2[15:8];	// @[GPIO.scala:96:22, :97:22]
        riseIpReg = _RANDOM_2[23:16];	// @[GPIO.scala:96:22, :98:22]
        fallIpReg = _RANDOM_2[31:24];	// @[GPIO.scala:96:22, :99:22]
        passthruHighIeReg = _RANDOM_3[7:0];	// @[GPIO.scala:100:30]
        passthruLowIeReg = _RANDOM_3[15:8];	// @[GPIO.scala:100:30, :101:30]
        xorReg = _RANDOM_3[31:24];	// @[GPIO.scala:100:30, :108:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  IntSyncCrossingSource_9 intsource (	// @[Crossing.scala:28:31]
    .clock           (clock),
    .reset           (reset),
  ...
  AsyncResetRegVec_w8_i0 oeReg (	// @[GPIO.scala:78:22]
    .clock (clock),
    .reset (reset),
    .io_d  (auto_control_xing_in_a_bits_data[7:0]),	// @[RegisterRouter.scala:83:24]
    .io_en (out_woready_6 & auto_control_xing_in_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
    .io_q  (_oeReg_io_q)
  );
  AsyncResetRegVec_w8_i0 pueReg (	// @[GPIO.scala:79:22]
    .clock (clock),
    .reset (reset),
    .io_d  (auto_control_xing_in_a_bits_data[7:0]),	// @[RegisterRouter.scala:83:24]
    .io_en (out_woready_12 & auto_control_xing_in_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
    .io_q  (_pueReg_io_q)
  );
  AsyncResetRegVec_w8_i0 ieReg (	// @[GPIO.scala:81:22]
    .clock (clock),
    .reset (reset),
    .io_d  (auto_control_xing_in_a_bits_data[39:32]),	// @[RegisterRouter.scala:83:24]
    .io_en (_out_wofireMux_T_2 & out_backSel_0 & _out_out_bits_data_WIRE_10 & auto_control_xing_in_a_bits_mask[4]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
    .io_q  (_ieReg_io_q)
  );
  AsyncResetRegVec_w8_i0 poeReg (	// @[GPIO.scala:83:22]
    .clock (clock),
    .reset (reset),
    .io_d  (8'h0),	// @[Bundles.scala:259:74]
    .io_en (1'h0),
    .io_q  (_poeReg_io_q)
  );
  SynchronizerShiftReg_w8_d3 inSyncReg_inSyncReg (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .io_d  ({auto_io_out_pins_7_i_ival, auto_io_out_pins_6_i_ival, auto_io_out_pins_5_i_ival, auto_io_out_pins_4_i_ival, auto_io_out_pins_3_i_ival, auto_io_out_pins_2_i_ival, auto_io_out_pins_1_i_ival, auto_io_out_pins_0_i_ival}),	// @[GPIO.scala:87:41]
    .io_q  (_inSyncReg_inSyncReg_io_q)
  );
  AsyncResetRegVec_w8_i0 iofEnReg (	// @[GPIO.scala:104:25]
    .clock (clock),
    .reset (reset),
    .io_d  (8'h0),	// @[Bundles.scala:259:74]
    .io_en (1'h0),
  ...
  assign auto_control_xing_in_d_bits_data = {24'h0, _GEN[auto_control_xing_in_a_bits_address[6:3]] ? _GEN_0[auto_control_xing_in_a_bits_address[6:3]] : 40'h0};	// @[Cat.scala:33:92, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
