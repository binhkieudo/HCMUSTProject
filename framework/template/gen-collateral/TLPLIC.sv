...
module TLPLIC(
  ...
  reg  [4:0]  enables_0_1;	// @[Plic.scala:176:51]
  reg  [3:0]  maxDevs_0;	// @[Plic.scala:181:22]
  reg  [2:0]  x1_0_REG;	// @[Plic.scala:188:45]
  wire [15:0] _completedDevs_T = 16'h1 << completerDev;	// @[OneHot.scala:64:12, RegisterRouter.scala:83:24, package.scala:155:13]
  wire [11:0] _GEN = completer_0 ? _completedDevs_T[12:1] : 12'h0;	// @[OneHot.scala:64:{12,27}, Plic.scala:264:28, :295:35]
  wire        _out_T_19 = {_out_back_io_deq_bits_index[22:19], _out_back_io_deq_bits_index[17:11], _out_back_io_deq_bits_index[8:3]} == 17'h0;	// @[Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire [31:0] _out_womask_T_10 = {{8{_out_back_io_deq_bits_mask[7]}}, {8{_out_back_io_deq_bits_mask[6]}}, {8{_out_back_io_deq_bits_mask[5]}}, {8{_out_back_io_deq_bits_mask[4]}}};	// @[Bitwise.scala:28:17, :77:12, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire        claimer_0 = _out_wofireMux_T & _out_back_io_deq_bits_read & out_backSel_32 & _out_T_19 & (|_out_womask_T_10);	// @[Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  ...
  wire [12:0] _out_completer_0_T = {enables_0_1, enables_0_0, 1'h0} >> completerDev;	// @[Cat.scala:33:92, Plic.scala:163:31, :174:26, :176:51, :295:51, RegisterRouter.scala:83:24, package.scala:155:13]
  assign completer_0 = out_woready_10 & (&_out_womask_T_10) & _out_completer_0_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire [5:0]  out_oindex = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[10:9], _out_back_io_deq_bits_index[2:0]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire [5:0]  _GEN_0 = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[10:9], _out_back_io_deq_bits_index[2:0]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_32 = _GEN_0 == 6'h20;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  ...
  wire        out_woready_3 = _out_wofireMux_T_2 & _GEN_0 == 6'h1 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire        out_woready_5 = _out_wofireMux_T_2 & _GEN_0 == 6'h2 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire        out_woready_7 = _out_wofireMux_T_2 & _GEN_0 == 6'h3 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire        out_woready_12 = _out_wofireMux_T_2 & _GEN_0 == 6'h4 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire        out_woready_1 = _out_wofireMux_T_2 & _GEN_0 == 6'h5 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire        out_woready_15 = _out_wofireMux_T_2 & _GEN_0 == 6'h10 & _out_T_19;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_woready_10 = _out_wofireMux_T_2 & out_backSel_32 & _out_T_19;	// @[RegisterRouter.scala:83:24]
  wire        _out_out_bits_data_T_10 = out_oindex == 6'h0;	// @[Cat.scala:33:92, MuxLiteral.scala:54:22]
  wire [3:0]  claiming = claimer_0 ? maxDevs_0 : 4'h0;	// @[Plic.scala:181:22, :246:49, RegisterRouter.scala:83:24]
  wire        claimedDevs_1 = claiming == 4'h1;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_2 = claiming == 4'h2;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_3 = claiming == 4'h3;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_4 = claiming == 4'h4;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_5 = claiming == 4'h5;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_6 = claiming == 4'h6;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_7 = claiming == 4'h7;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_8 = claiming == 4'h8;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_9 = claiming == 4'h9;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_10 = claiming == 4'hA;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_11 = claiming == 4'hB;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  wire        claimedDevs_12 = claiming == 4'hC;	// @[OneHot.scala:64:{12,27}, Plic.scala:246:49, :247:62]
  always @(posedge clock) begin
    if (_out_wofireMux_T_2 & _GEN_0 == 6'h0 & _out_T_19 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
    ...
    if (out_woready_5 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
      priority_4 <= _out_back_io_deq_bits_data[34:32];	// @[Decoupled.scala:375:21, Plic.scala:163:31, RegisterRouter.scala:83:24]
    if (out_woready_7 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
      priority_5 <= _out_back_io_deq_bits_data[2:0];	// @[Decoupled.scala:375:21, Plic.scala:163:31, RegisterRouter.scala:83:24]
    if (out_woready_7 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
    ...
    if (out_woready_12 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
    ...
    if (_out_wofireMux_T_2 & _GEN_0 == 6'h6 & _out_T_19 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
    ...
    if (out_woready_15 & _out_back_io_deq_bits_mask[1])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
      enables_0_1 <= _out_back_io_deq_bits_data[12:8];	// @[Decoupled.scala:375:21, Plic.scala:176:51, RegisterRouter.scala:83:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        threshold_0 = _RANDOM_1[6:4];	// @[Plic.scala:163:31, :166:31]
        pending_0 = _RANDOM_1[7];	// @[Plic.scala:163:31, :168:26]
        pending_1 = _RANDOM_1[8];	// @[Plic.scala:163:31, :168:26]
        pending_2 = _RANDOM_1[9];	// @[Plic.scala:163:31, :168:26]
        pending_3 = _RANDOM_1[10];	// @[Plic.scala:163:31, :168:26]
        pending_4 = _RANDOM_1[11];	// @[Plic.scala:163:31, :168:26]
        pending_5 = _RANDOM_1[12];	// @[Plic.scala:163:31, :168:26]
        pending_6 = _RANDOM_1[13];	// @[Plic.scala:163:31, :168:26]
        pending_7 = _RANDOM_1[14];	// @[Plic.scala:163:31, :168:26]
        pending_8 = _RANDOM_1[15];	// @[Plic.scala:163:31, :168:26]
        pending_9 = _RANDOM_1[16];	// @[Plic.scala:163:31, :168:26]
        pending_10 = _RANDOM_1[17];	// @[Plic.scala:163:31, :168:26]
        pending_11 = _RANDOM_1[18];	// @[Plic.scala:163:31, :168:26]
        enables_0_0 = _RANDOM_1[25:19];	// @[Plic.scala:163:31, :174:26]
        enables_0_1 = _RANDOM_1[30:26];	// @[Plic.scala:163:31, :176:51]
        maxDevs_0 = {_RANDOM_1[31], _RANDOM_2[2:0]};	// @[Plic.scala:163:31, :181:22]
        x1_0_REG = _RANDOM_2[5:3];	// @[Plic.scala:181:22, :188:45]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  PLICFanIn fanin (	// @[Plic.scala:184:25]
    ...
    .io_ip      ({enables_0_1, enables_0_0} & {pending_11, pending_10, pending_9, pending_8, pending_7, pending_6, pending_5, pending_4, pending_3, pending_2, pending_1, pending_0}),	// @[Cat.scala:33:92, Plic.scala:168:26, :174:26, :176:51, :186:40]
    .io_dev     (_fanin_io_dev),
    .io_max     (_fanin_io_max)
  );
  Queue_26 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
  ...
  assign auto_in_d_bits_data = ~(_out_out_bits_data_T_10 | out_oindex == 6'h1 | out_oindex == 6'h2 | out_oindex == 6'h3 | out_oindex == 6'h4 | out_oindex == 6'h5 | out_oindex == 6'h6 | out_oindex == 6'h8 | out_oindex == 6'h10 | out_oindex == 6'h20) | _out_T_19 ? (_out_out_bits_data_T_10 ? {29'h0, priority_0, 32'h0} : out_oindex == 6'h1 ? {29'h0, priority_2, 29'h0, priority_1} : out_oindex == 6'h2 ? {29'h0, priority_4, 29'h0, priority_3} : out_oindex == 6'h3 ? {29'h0, priority_6, 29'h0, priority_5} : out_oindex == 6'h4 ? {29'h0, priority_8, 29'h0, priority_7} : out_oindex == 6'h5 ? {29'h0, priority_10, 29'h0, priority_9} : out_oindex == 6'h6 ? {61'h0, priority_11} : out_oindex == 6'h8 ? {51'h0, pending_11, pending_10, pending_9, pending_8, pending_7, pending_6, pending_5, pending_4, pending_3, pending_2, pending_1, pending_0, 1'h0} : out_oindex == 6'h10 ? {51'h0, enables_0_1, enables_0_0, 1'h0} : out_oindex == 6'h20 ? {28'h0, maxDevs_0, 29'h0, threshold_0} : 64'h0) : 64'h0;	// @[Cat.scala:33:92, MuxLiteral.scala:52:28, :54:{22,28}, Plic.scala:163:31, :166:31, :168:26, :174:26, :176:51, :181:22, RegisterRouter.scala:83:24]
endmodule
