...
module SPIMedia(
  ...
  wire            cs_deassert = clear | cs_active_0 != cs_dflt_0 & ~io_link_cs_hold;	// @[SPIBundle.scala:49:33, SPIMedia.scala:49:15, :52:37, :54:18, :56:{27,41,44}]
  ...
  assign io_link_active = cs_assert;	// @[SPIMedia.scala:55:22]
endmodule
