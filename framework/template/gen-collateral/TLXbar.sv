...
module TLXbar(
  ...
  wire        requestAIO_0_0 = ~(auto_in_0_a_bits_address[31]) | {~(auto_in_0_a_bits_address[31]), auto_in_0_a_bits_address[29:28]} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  wire [3:0]  _GEN = auto_in_0_a_bits_address[31:28] ^ 4'h9;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {_GEN[3], _GEN[1:0]} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_1_0 = ~(auto_in_1_a_bits_address[31]) | {~(auto_in_1_a_bits_address[31]), auto_in_1_a_bits_address[29:28]} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  wire [3:0]  _GEN_0 = auto_in_1_a_bits_address[31:28] ^ 4'h9;	// @[Parameters.scala:137:31]
  wire        requestAIO_1_1 = {_GEN_0[3], _GEN_0[1:0]} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch_2)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft_2 <= beatsLeft_2 - {8'h0, auto_in_0_d_ready & out_10_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:259:74, ReadyValidCancel.scala:49:33]
      ...
      if (latch_3)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft_3 <= beatsLeft_3 - {8'h0, auto_in_1_d_ready & out_14_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:259:74, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_1_d_bits_data = (muxStateEarly_3_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_in_0_d_bits_data = (muxStateEarly_2_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_1_a_bits_data = (muxStateEarly_1_0 ? auto_in_0_a_bits_data : 64'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_0_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 64'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
