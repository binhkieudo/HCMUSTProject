...
module TLSerdesser(
  ...
  input  [6:0]  auto_manager_in_a_bits_source,
  ...
  output [6:0]  auto_manager_in_d_bits_source,
  ...
  reg  [8:0]  merged_bits_last_counter_4;	// @[Edges.scala:229:27]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      merged_bits_last_counter_4 <= 9'h0;	// @[Edges.scala:229:27]
    end
    else begin
      ...
      if (_outArb_io_in_4_ready & auto_manager_in_a_valid) begin	// @[Decoupled.scala:51:35, Serdes.scala:638:24]
        if (merged_bits_last_counter_4 == 9'h0) begin	// @[Edges.scala:229:27, :231:25]
          if (auto_manager_in_a_bits_opcode[2])	// @[Edges.scala:92:37]
            merged_bits_last_counter_4 <= 9'h0;	// @[Edges.scala:229:27]
          else	// @[Edges.scala:92:37]
            merged_bits_last_counter_4 <= ~(_merged_bits_last_beats1_decode_T_13[11:3]);	// @[Edges.scala:229:27, package.scala:235:{46,71,76}]
        end
        else	// @[Edges.scala:231:25]
          merged_bits_last_counter_4 <= merged_bits_last_counter_4 - 9'h1;	// @[Edges.scala:229:27, :230:28]
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        merged_bits_last_counter_4 = _RANDOM_1[12:4];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  HellaPeekingArbiter outArb (	// @[Serdes.scala:638:24]
    ...
    .io_in_4_bits_source  ({1'h0, auto_manager_in_a_bits_source}),	// @[Bundles.scala:262:74, Serdes.scala:257:20]
    ...
    .io_in_4_bits_last    (merged_bits_last_counter_4 == 9'h1 | (auto_manager_in_a_bits_opcode[2] ? 9'h0 : ~(_merged_bits_last_beats1_decode_T_13[11:3])) == 9'h0),	// @[Edges.scala:92:37, :221:14, :229:27, :232:{25,33,43}, package.scala:235:{46,71,76}]
  ...
  GenericDeserializer inDes (	// @[Serdes.scala:645:23]
    ...
    .io_out_ready        (_inDes_io_out_bits_chanId != 3'h4 & (_inDes_io_out_ready_T_6 ? auto_manager_in_d_ready : ~(_inDes_io_out_bits_chanId == 3'h2 | _inDes_io_out_bits_chanId == 3'h1) & _inDes_io_out_ready_T & auto_client_out_a_ready)),	// @[Mux.scala:81:58, Serdes.scala:234:37, :235:37, :236:37, :237:37, :238:37, :331:20, :645:23]
  ...
  assign auto_manager_in_d_bits_size = _inDes_io_out_bits_size[2:0];	// @[Serdes.scala:401:15, :645:23]
  assign auto_manager_in_d_bits_source = _inDes_io_out_bits_source[6:0];	// @[Serdes.scala:402:15, :645:23]
