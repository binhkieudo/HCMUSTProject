...
module Queue_31(
  ...
  wire [123:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[50:19];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[58:51];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[122:59];	// @[Decoupled.scala:273:95]
endmodule
