...
module TLXbar_2(
  ...
  output [30:0] auto_out_7_a_bits_address,
  ...
  output [30:0] auto_out_6_a_bits_address,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[29:28], auto_in_a_bits_address[26], auto_in_a_bits_address[13:12]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{45,65}]
  wire [3:0]  _GEN = auto_in_a_bits_address[29:26] ^ 4'h9;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {_GEN[3:2], _GEN[0], auto_in_a_bits_address[13:12]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire [17:0] _GEN_0 = auto_in_a_bits_address[29:12] ^ 18'h24001;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_2 = {_GEN_0[17:16], _GEN_0[14], _GEN_0[1:0]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire [17:0] _GEN_1 = auto_in_a_bits_address[29:12] ^ 18'h24003;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_3 = {_GEN_1[17:16], _GEN_1[14], _GEN_1[1:0]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {auto_in_a_bits_address[29:28] ^ 2'h1, auto_in_a_bits_address[26], auto_in_a_bits_address[13:12]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[29:28] ^ 2'h2, auto_in_a_bits_address[26]} == 3'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire [17:0] _GEN_2 = auto_in_a_bits_address[29:12] ^ 18'h24002;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_6 = {_GEN_2[17:16], _GEN_2[14], _GEN_2[1:0]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_7 = {~(auto_in_a_bits_address[29:28]), auto_in_a_bits_address[26], auto_in_a_bits_address[13:12]} == 5'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  ...
  wire [6:0]  _GEN_3 = _readys_filter_T_1[6:0] | _readys_filter_T_1[7:1];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_4 = auto_out_7_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        _GEN_9 = _GEN_3[5] | _readys_filter_T_1[7];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire [4:0]  _GEN_10 = _GEN_3[4:0] | _GEN_3[6:2];	// @[package.scala:254:43]
  wire        _GEN_11 = _GEN_4 | _GEN_3[1];	// @[package.scala:254:43]
  wire        _GEN_12 = _GEN_5 | _GEN_3[0];	// @[package.scala:254:43]
  wire        _GEN_13 = _GEN_6 | _GEN_4;	// @[package.scala:254:43]
  wire [7:0]  readys_readys = ~({readys_mask[7], _readys_filter_T_1[7] | readys_mask[6], _GEN_3[6] | readys_mask[5], _GEN_9 | readys_mask[4], _GEN_10[4] | readys_mask[3], _GEN_10[3] | _readys_filter_T_1[7] | readys_mask[2], _GEN_10[2] | _GEN_3[6] | readys_mask[1], _GEN_10[1] | _GEN_9 | readys_mask[0]} & {_GEN_10[0] | _GEN_10[4], _GEN_11 | _GEN_10[3], _GEN_12 | _GEN_10[2], _GEN_13 | _GEN_10[1], _GEN_7 | _GEN_5 | _GEN_10[0], _GEN_8 | _GEN_6 | _GEN_11, auto_out_2_d_valid | auto_out_3_d_valid | _GEN_7 | _GEN_12, auto_out_1_d_valid | auto_out_2_d_valid | _GEN_8 | _GEN_13});	// @[Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43]
  ...
  wire [12:0] _beatsDO_decode_T_29 = 13'h3F << auto_out_7_d_bits_size;	// @[package.scala:235:71]
  wire [12:0] _beatsDO_decode_T_25 = 13'h3F << auto_out_6_d_bits_size;	// @[package.scala:235:71]
  wire [12:0] _beatsDO_decode_T_21 = 13'h3F << auto_out_5_d_bits_size;	// @[package.scala:235:71]
  wire [12:0] _beatsDO_decode_T_17 = 13'h3F << auto_out_4_d_bits_size;	// @[package.scala:235:71]
  ...
  wire [7:0]  _readys_mask_T_6 = _readys_mask_T_3 | {_readys_mask_T_3[5:0], 2'h0};	// @[Arbiter.scala:88:30, package.scala:245:{43,53}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0) | (winnerQual_3 & auto_out_3_d_bits_opcode[0] ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0) | (winnerQual_4 & auto_out_4_d_bits_opcode[0] ? ~(_beatsDO_decode_T_17[5:3]) : 3'h0) | (winnerQual_5 ? ~(_beatsDO_decode_T_21[5:3]) : 3'h0) | (winnerQual_6 & auto_out_6_d_bits_opcode[0] ? ~(_beatsDO_decode_T_25[5:3]) : 3'h0) | (winnerQual_7 & auto_out_7_d_bits_opcode[0] ? ~(_beatsDO_decode_T_29[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {2'h0, auto_in_d_ready & out_27_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
      if (latch & (|readys_valid))	// @[Arbiter.scala:28:{18,27}, :90:24, Cat.scala:33:92]
        readys_mask <= _readys_mask_T_6 | {_readys_mask_T_6[3:0], 4'h0};	// @[Arbiter.scala:24:23, package.scala:245:{43,53}, :254:43]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[10:3];	// @[Arbiter.scala:24:23, :88:30]
        ...
        state_3 = _RANDOM_0[14];	// @[Arbiter.scala:88:30, :117:26]
        state_4 = _RANDOM_0[15];	// @[Arbiter.scala:88:30, :117:26]
        state_5 = _RANDOM_0[16];	// @[Arbiter.scala:88:30, :117:26]
        state_6 = _RANDOM_0[17];	// @[Arbiter.scala:88:30, :117:26]
        state_7 = _RANDOM_0[18];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_5} | (muxStateEarly_6 ? auto_out_6_d_bits_opcode : 3'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_opcode : 3'h0);	// @[Arbiter.scala:88:30, :118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_size : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_size : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_size : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_size : 3'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_size : 3'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_size : 3'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_size : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_5_a_bits_address = auto_in_a_bits_address[29:0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_4_a_bits_address = auto_in_a_bits_address[28:0];	// @[BundleMap.scala:247:19]
