...
module ClockSinkDomain_7(
  ...
  input  [8:0]  auto_xbar_in_a_bits_source,
  ...
  output [8:0]  auto_xbar_in_d_bits_source,
  ...
  wire [8:0]  _reset_setter_auto_tl_in_d_bits_source;	// @[HasChipyardPRCI.scala:89:34]
  ...
  wire [8:0]  _clock_gater_auto_clock_gater_in_1_d_bits_source;	// @[HasChipyardPRCI.scala:84:33]
  ...
  wire [8:0]  _xbar_auto_out_1_a_bits_source;	// @[Xbar.scala:145:26]
  ...
  wire [8:0]  _xbar_auto_out_0_a_bits_source;	// @[Xbar.scala:145:26]
