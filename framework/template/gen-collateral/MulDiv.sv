...
module MulDiv(
  ...
  wire         _GEN_0 = _T_14 & count == 7'h7;	// @[Multiplier.scala:51:18, :98:57, :103:{39,50}, :121:{25,55}, :122:13]
  ...
  always @(posedge clock) begin
    ...
    if (_T_23) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_17) begin	// @[Multiplier.scala:126:39]
        ...
        remainder <= {_GEN[72:8], count == 7'h6 & neg_out, _GEN[7:0], remainder[63:8]};	// @[Cat.scala:33:92, Multiplier.scala:51:18, :54:20, :58:22, :106:24, :109:76, :110:38, :111:{32,61}, :118:{34,67}]
      end
